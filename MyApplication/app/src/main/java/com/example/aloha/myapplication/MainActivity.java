...
import com.example.aloha.myapplication.data.Atmosphere;
...
public class MainActivity extends AppCompatActivity implements WeatherCallBack {
    ...
    public void serviceSuccess(Channel channel) {
        ...
        windTv.setText("Wind : "+ String.valueOf(wind.getDetrection()+wind.getSpeed())+" km/h");
        humidityTv.setText("Humidity : "+String.valueOf(atmosphere.getHumid())+"%");
